...
svm_model = LinearSVC(penalty = 'l2',dual = False, C = 0.7, loss = 'hinge')
svm_model = svm_model.fit(X=X_train, y=y_train)
y_pred = svm_model.predict(X_test)

accu_score = cross_val_score(svm_model,X_test,y_test,cv=10,scoring='accuracy').mean()
print "\n"
print "accuracy score : ",accu_score  
precision_score = cross_val_score(svm_model,X_test,y_test,cv=10,scoring='precision').mean()
print "\n"
print "precision score : ",precision_score
recall_score = cross_val_score(svm_model,X_test,y_test,cv=10,scoring='recall').mean()
print "\n"
print "recall score : ",recall_score
f1_score = cross_val_score(svm_model,X_test,y_test,cv=10,scoring='f1').mean()
print "\n"
