...
nb_model = MultinomialNB(alpha = 0.2 ,fit_prior = False)
nb_model = nb_model.fit(X=X_train, y=y_train)
y_pred = nb_model.predict(X_test)

accu_score = cross_val_score(nb_model,X_test,y_test ,cv=10 ,scoring='accuracy').mean()
print "\n"
print "accuracy score : ",accu_score  
precision_score = cross_val_score(nb_model,X_test,y_test,cv=10,scoring='precision').mean()
print "\n"
print "precision score : ",precision_score
recall_score = cross_val_score(nb_model,X_test,y_test,cv=10,scoring='recall').mean()
print "\n"
print "recall score : ",recall_score
f1_score = cross_val_score(nb_model,X_test,y_test,cv=10,scoring='f1').mean()
print "\n"
